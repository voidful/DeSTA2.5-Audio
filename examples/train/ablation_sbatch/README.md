...
基於當前 ORCA 架構（移除 2 個正交性損失、使用所有 32 層、2x downsample）的系統性 ablation study。

---

## 實驗列表

| Exp | 名稱 | Global (32L) | Local (2x) | Deep Inj | Diversity | Alignment | 腳本 |
|-----|------|-------------|-----------|----------|-----------|-----------|------|
...
| 5 | + Alignment | ✅ | ✅ | ✅ | ✅ | ✅ | `exp5_add_alignment.sbatch` |
| 6 | Full ORCA | ✅ | ✅ | ✅ | ✅ | ✅ | `exp6_full_orca.sbatch` |
...
- **配置**: + Local (2x downsample), no deep injection/losses
